    ...
    <footer className={styles.footer}>
      <div className={`${styles.inner} container`}>
        <div className={`${styles.column} ${styles.brandColumn}`}>
          <Link href="/" className={styles.brandLink} aria-label="WealthRise Capitals home">
            ...
            <p className={styles.tagline}>
              Growing Wealth &nbsp;&middot;&nbsp; Creating Futures
            </p>
          </Link>
        ...
        <div className={styles.column}>
          <h3>Location</h3>
          <p>
            WealthRise Capitals Advisory Desk<br />
          ...
          <div className={styles.mapContainer}>
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15224.97746430335!2d78.3370635!3d17.4111364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb95a2872bc0e5%3A0xe6bf44bc9dd25fd!2sFinancial%20District%2C%20Nanakramguda%2C%20Hyderabad%2C%20Telangana!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              title="WealthRise Capitals Location"
              className={styles.mapFrame}
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
            ></iframe>
            <div className={styles.mapRadarPing} />
          </div>
        </div>

        <div className={styles.column}>
          <h3>Contact</h3>
          <a href="mailto:hello@way2wealth4u.com" className={styles.iconLink}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="20" height="20">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
            </svg>
            Advisory Inbox
          </a>
          <a href="tel:+919000000000" className={styles.iconLink}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="20" height="20">
